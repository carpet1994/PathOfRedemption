...
namespace LaViaDellaRedenzione.Core
{
    ...
    public sealed class PlayerEntity
    {
        ...
        /// <summary>
        /// Generatore di numeri casuali condiviso dall'intera classe.
        /// Dichiarato static per evitare il problema del seed identico
        /// quando più istanze di Random vengono create nello stesso millisecondo.
        /// </summary>
