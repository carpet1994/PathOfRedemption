...
namespace LaViaDellaRedenzione.Core
{
    ...
    public sealed class SpriteSheet
    {
        ...
        private void AdvanceFrame()
        {
            ...
            // Controlla HitFrame dopo l'avanzamento: l'evento scatta quando
            // _frameIndex punta al frame effettivamente mostrato dal renderer,
            // garantendo che danno e VFX siano sincronizzati con l'animazione.
            CheckHitFrame();
        }
